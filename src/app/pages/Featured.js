        ...
        productsList.forEach((item, index) => {
            if(Array.isArray(item)) {
                ...
                if(this.state.filterSliderPriceValue.length === 0 && this.state.filterSliderSizeValues.length === 0) {
                    return  index >= 0 && index <= 8 ? products.push(item) : null
                    ...
                    if(this.state.filterSliderSizeValues.length === 1) {
                        return  (index >= 0 && index <= 8) && (+item[0].props.price.slice(1) >= +this.state.filterSliderPriceValue[0].slice(1) && +item[0].props.price.slice(1) <= +this.state.filterSliderPriceValue[1].slice(1)) && (this.state.filterSliderSizeValues[0] === item[0].props.size) ? products.push(item) : null
                    } else {
                        return  (index >= 0 && index <= 8) && (+item[0].props.price.slice(1) >= +this.state.filterSliderPriceValue[0].slice(1) && +item[0].props.price.slice(1) <= +this.state.filterSliderPriceValue[1].slice(1)) && (this.state.filterSliderSizeValues.find(size => size === item[0].props.size)) ? products.push(item) : null
                    }

                } else if(this.state.filterSliderPriceValue.length !== 0 && this.state.filterSliderSizeValues.length === 0) {
                    return  (index >= 0 && index <= 8) && (+item[0].props.price.slice(1) >= +this.state.filterSliderPriceValue[0].slice(1) && +item[0].props.price.slice(1) <= +this.state.filterSliderPriceValue[1].slice(1)) ? products.push(item) : null
                } else if(this.state.filterSliderPriceValue.length === 0 && this.state.filterSliderSizeValues.length !== 0) {

                    if(this.state.filterSliderSizeValues.length === 1) {
                        return (index >= 0 && index <= 8) && (this.state.filterSliderSizeValues[0] === item[0].props.size) ? products.push(item) : null
                    } else {
                        return (index >= 0 && index <= 8) && (this.state.filterSliderSizeValues.find(size => size === item[0].props.size)) ? products.push(item) : null
                    }
                ...
                if(this.state.filterSliderPriceValue.length === 0 && this.state.filterSliderSizeValues.length === 0) {
                    ...
                    if(this.state.filterSliderSizeValues.length === 1) {
                        return  (index >= 0 && index <= 8) && (+item.props.price.slice(1) >= +this.state.filterSliderPriceValue[0].slice(1) && +item.props.price.slice(1) <= +this.state.filterSliderPriceValue[1].slice(1)) && (this.state.filterSliderSizeValues[0] === item.props.size) ? products.push(item) : null
                    } else {
                        return  (index >= 0 && index <= 8) && (+item.props.price.slice(1) >= +this.state.filterSliderPriceValue[0].slice(1) && +item.props.price.slice(1) <= +this.state.filterSliderPriceValue[1].slice(1)) && (this.state.filterSliderSizeValues.find(size => size === item.props.size)) ? products.push(item) : null
                    }

                } else if(this.state.filterSliderPriceValue.length !== 0 && this.state.filterSliderSizeValues.length === 0) {
                    return  (index >= 0 && index <= 8) && (+item.props.price.slice(1) >= +this.state.filterSliderPriceValue[0].slice(1) && +item.props.price.slice(1) <= +this.state.filterSliderPriceValue[1].slice(1)) ? products.push(item) : null
                } else if(this.state.filterSliderPriceValue.length === 0 && this.state.filterSliderSizeValues.length !== 0) {

                    if(this.state.filterSliderSizeValues.length === 1) {
                        return (index >= 0 && index <= 8) && (this.state.filterSliderSizeValues[0] === item.props.size) ? products.push(item) : null
                    } else {
                        return (index >= 0 && index <= 8) && (this.state.filterSliderSizeValues.find(size => size === item.props.size)) ? products.push(item) : null
                    }
        ...
        return (
            <>
                <Switch>
                    ...
                    <Route path="/featured/:productId" component={Product} />
