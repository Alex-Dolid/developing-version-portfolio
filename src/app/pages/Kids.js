        ...
        productsList.forEach((item, index) => {
            if(Array.isArray(item)) {
                ...
                if(this.state.filterSliderPriceValue.length === 0 && this.state.filterSliderSizeValues.length === 0) {
                    return  item[0].props.url === "/kids" ? products.push(item) : null
                    ...
                    if(this.state.filterSliderSizeValues.length === 1) {
                        return  (item[0].props.url === "/kids") && (+item[0].props.price.slice(1) >= +this.state.filterSliderPriceValue[0].slice(1) && +item[0].props.price.slice(1) <= +this.state.filterSliderPriceValue[1].slice(1)) && (this.state.filterSliderSizeValues[0] === item[0].props.size) ? products.push(item) : null
                    } else {
                        return  (item[0].props.url === "/kids") && (+item[0].props.price.slice(1) >= +this.state.filterSliderPriceValue[0].slice(1) && +item[0].props.price.slice(1) <= +this.state.filterSliderPriceValue[1].slice(1)) && (this.state.filterSliderSizeValues.find(size => size === item[0].props.size)) ? products.push(item) : null
                    }

                } else if(this.state.filterSliderPriceValue.length !== 0 && this.state.filterSliderSizeValues.length === 0) {
                    return  (item[0].props.url === "/kids") && (+item[0].props.price.slice(1) >= +this.state.filterSliderPriceValue[0].slice(1) && +item[0].props.price.slice(1) <= +this.state.filterSliderPriceValue[1].slice(1)) ? products.push(item) : null
                } else if(this.state.filterSliderPriceValue.length === 0 && this.state.filterSliderSizeValues.length !== 0) {

                    if(this.state.filterSliderSizeValues.length === 1) {
                        return (item[0].props.url === "/kids") && (this.state.filterSliderSizeValues[0] === item[0].props.size) ? products.push(item) : null
                    } else {
                        return (item[0].props.url === "/kids") && (this.state.filterSliderSizeValues.find(size => size === item[0].props.size)) ? products.push(item) : null
                    }
                ...
                if(this.state.filterSliderPriceValue.length === 0 && this.state.filterSliderSizeValues.length === 0) {
                    return  item.props.url === "/kids" ? products.push(item) : null
                } else if(this.state.filterSliderPriceValue.length !== 0 && this.state.filterSliderSizeValues.length !== 0) {

                    if(this.state.filterSliderSizeValues.length === 1) {
                        return  (item.props.url === "/kids") && (+item.props.price.slice(1) >= +this.state.filterSliderPriceValue[0].slice(1) && +item.props.price.slice(1) <= +this.state.filterSliderPriceValue[1].slice(1)) && (this.state.filterSliderSizeValues[0] === item.props.size) ? products.push(item) : null
                    } else {
                        return  (item.props.url === "/kids") && (+item.props.price.slice(1) >= +this.state.filterSliderPriceValue[0].slice(1) && +item.props.price.slice(1) <= +this.state.filterSliderPriceValue[1].slice(1)) && (this.state.filterSliderSizeValues.find(size => size === item.props.size)) ? products.push(item) : null
                    }

                } else if(this.state.filterSliderPriceValue.length !== 0 && this.state.filterSliderSizeValues.length === 0) {
                    return  (item.props.url === "/kids") && (+item.props.price.slice(1) >= +this.state.filterSliderPriceValue[0].slice(1) && +item.props.price.slice(1) <= +this.state.filterSliderPriceValue[1].slice(1)) ? products.push(item) : null
                } else if(this.state.filterSliderPriceValue.length === 0 && this.state.filterSliderSizeValues.length !== 0) {

                    if(this.state.filterSliderSizeValues.length === 1) {
                        return (item.props.url === "/kids") && (this.state.filterSliderSizeValues[0] === item.props.size) ? products.push(item) : null
                    } else {
                        return (item.props.url === "/kids") && (this.state.filterSliderSizeValues.find(size => size === item.props.size)) ? products.push(item) : null
                    }
        ...
        return (
            <>
                <Switch>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xl-9 product d-flex flex-wrap justify-content-around">
                                        <div className="top-filter d-flex w-100 justify-content-around flex-wrap mb-5  ">
                                            ...
                                            <FilterSliderPrice onMouseDownFilterSliderPrice={this.onMouseDownFilterSliderPrice} onMouseUpFilterSliderPrice={this.onMouseUpFilterSliderPrice}/>
                                            <FilterSort/>
                                        </div>
                                        {products}
                                    </div>
                                    <div className="col-xl-9 ml-auto d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <Link to="/kids" className="button button_border button_animate-products" onClick={this.clearFilters}>View All</Link>
                                    </div>
                                </div>
                            </div>
                        </section>
                    ...
                    <Route path="/kids/:productId" component={Product} />
                    <Redirect from="*" to="/kids"/>
                </Switch>
            </>
        );
    }
