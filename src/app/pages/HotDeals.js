...
export default class HotDeals extends React.Component {
    ...
    render() {
        ...
        productsList.forEach((item) => {
            return  item.props.url === "/hot_deals" ? products.push(item) : null
        });

        return (
            <>
                <Switch>
                    <Route exact path="/hot_deals">
                            ...
                            <div className="container">
                                <div className="row">
                                    ...
                                    <div className="col-xl-9 ml-auto d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <Link to="/hot_deals" className="button button_border button_animate-products">View All</Link>
                                    </div>
                                </div>
                            </div>
                        </section>
                    ...
                    <Route path="/hot_deals/:productId" component={Product} />
                    <Redirect from="*" to="/hot_deals"/>
                </Switch>
            </>
        );
    }
